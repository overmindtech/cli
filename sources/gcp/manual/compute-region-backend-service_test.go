...
func TestComputeRegionBackendService(t *testing.T) {
	...
	mockClient := mocks.NewMockComputeRegionBackendServiceClient(ctrl)
	projectID := "test-project"
	region := "test-region"

	t.Run("Get", func(t *testing.T) {
		wrapper := manual.NewComputeRegionBackendService(mockClient, []gcpshared.LocationInfo{gcpshared.NewRegionalLocation(projectID, region)})
	...
	t.Run("List", func(t *testing.T) {
		...
		mockBackendServiceIterator.EXPECT().Next().Return(createComputeRegionBackendService("test-backend-service"), nil)
		mockBackendServiceIterator.EXPECT().Next().Return(createComputeRegionBackendService("test-backend-service"), nil)
	...
	t.Run("ListStream", func(t *testing.T) {
		...
		mockBackendServiceIterator.EXPECT().Next().Return(createComputeRegionBackendService("test-backend-service-1"), nil)
		mockBackendServiceIterator.EXPECT().Next().Return(createComputeRegionBackendService("test-backend-service-2"), nil)
		mockBackendServiceIterator.EXPECT().Next().Return(nil, iterator.Done)
	...
	t.Run("GetWithHealthCheck", func(t *testing.T) {
		...
		backendService := createComputeRegionBackendService("test-backend-service")
...
func createComputeRegionBackendService(name string) *computepb.BackendService {
	return &computepb.BackendService{
		...
		Backends: []*computepb.Backend{
			{
				Group: ptr.To("https://compute.googleapis.com/compute/v1/projects/test-project/zones/test-zone/nodeGroups/test-instance-group"),
			},
		},
	}
}
