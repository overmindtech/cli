...
//
//	mockgen -destination=./mocks/mock_big_query_dataset_client.go -package=mocks -source=big-query-clients.go -imports=sdp=github.com/overmindtech/workspace/sdp-go
//
...
import (
	...
	sdp "github.com/overmindtech/workspace/sdp-go"
