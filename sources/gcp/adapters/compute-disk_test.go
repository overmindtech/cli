...
func TestComputeDisk(t *testing.T) {
	...
	t.Run("Get", func(t *testing.T) {
		wrapper := adapters.NewComputeDisk(mockClient, projectID, zone)
		...
		t.Run("StaticTests", func(t *testing.T) {
			...
			cases := []staticTestCase{
				{
					...
					expectedLinked: shared.QueryTests{
						{
							ExpectedType:             adapters.ComputeImage.String(),
				...
				},
				{
					...
					expectedLinked: shared.QueryTests{
						{
							ExpectedType:             adapters.ComputeSnapshot.String(),
							ExpectedMethod:           sdp.QueryMethod_GET,
				...
				},
				{
					...
					expectedLinked: shared.QueryTests{
						{
							ExpectedType:             adapters.ComputeInstantSnapshot.String(),
							ExpectedMethod:           sdp.QueryMethod_GET,
				...
				},
				{
					...
					expectedLinked: shared.QueryTests{
						{
							ExpectedType:             adapters.ComputeDisk.String(),
							ExpectedMethod:           sdp.QueryMethod_GET,
			...
			userTest := shared.QueryTest{
				ExpectedType:             adapters.ComputeInstance.String(),
				ExpectedMethod:           sdp.QueryMethod_GET,
			...
			diskTypeTest := shared.QueryTest{
				ExpectedType:             adapters.ComputeDiskType.String(),
				ExpectedMethod:           sdp.QueryMethod_GET,
			...
			diskEncryptionKeyTest := shared.QueryTest{
				ExpectedType:             adapters.CloudKMSCryptoKeyVersion.String(),
				ExpectedMethod:           sdp.QueryMethod_GET,
