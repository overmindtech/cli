...
func TestComputeInstanceGroupManager(t *testing.T) {
	...
	t.Run("Get", func(t *testing.T) {
		wrapper := adapters.NewComputeInstanceGroupManager(mockClient, projectID, zone)
		...
		if sdpItem.GetType() != adapters.ComputeInstanceGroupManager.String() {
			t.Fatalf("Expected type %s, got: %s", adapters.ComputeInstanceGroupManager.String(), sdpItem.GetType())
		}
		...
		t.Run("StaticTests", func(t *testing.T) {
			t.Run("GlobalInstanceTemplate", func(t *testing.T) {
				...
				queryTests := shared.QueryTests{
					{
						ExpectedType:   adapters.ComputeInstanceTemplate.String(),
					...
					{
						ExpectedType:   adapters.ComputeInstanceGroup.String(),
						ExpectedMethod: sdp.QueryMethod_GET,
					...
					{
						ExpectedType:   adapters.ComputeTargetPool.String(),
						ExpectedMethod: sdp.QueryMethod_GET,
			...
			t.Run("RegionalInstanceTemplate", func(t *testing.T) {
				...
				queryTests := shared.QueryTests{
					{
						ExpectedType:   adapters.ComputeRegionInstanceTemplate.String(),
						ExpectedMethod: sdp.QueryMethod_GET,
						ExpectedQuery:  "unit-test-template",
