...
type AccountProperties struct {
	...
	Plan          AccountPlan `protobuf:"varint,3,opt,name=Plan,proto3,enum=account.AccountPlan" json:"Plan,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *AccountProperties) GetPlan() AccountPlan {
	if x != nil {
		return x.Plan
	}
...
const file_account_proto_rawDesc = "" +
	...
	"\x06status\x18\x04 \x01(\x0e2\x19.account.RepositoryStatusB\b\xbaH\x05\x82\x01\x02\x10\x01R\x06status\"\x87\x01\n" +
	"\x11AccountProperties\x12\x12\n" +
	"\x04Name\x18\x01 \x01(\tR\x04Name\x12*\n" +
	"\x10StripeCustomerID\x18\x02 \x01(\tR\x10StripeCustomerID\x122\n" +
	"\x04Plan\x18\x03 \x01(\x0e2\x14.account.AccountPlanB\b\xbaH\x05\x82\x01\x02\x10\x01R\x04Plan\"\x13\n" +
...
var file_account_proto_depIdxs = []int32{
	...
	65, // 22: account.Repository.lastChangeAt:type_name -> google.protobuf.Timestamp
	1,  // 23: account.Repository.status:type_name -> account.RepositoryStatus
	2,  // 24: account.AccountProperties.Plan:type_name -> account.AccountPlan
